...
int ji = 0;
SRTF::SRTF(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::SRTF)
{
    ui->setupUi(this);

    connect(ui->back, &QPushButton::released,[=](){emit srtf_signal();});    //返回按钮
